...
public:
    ...
    // supervisor trap
    static void ivt();
    static void supervisorTrap1();
    static void supervisorTrap2();
    static void supervisorTrap3();

private:

    // supervisor trap handler
    static void handleSupervisorTrap1();
    static void handleSupervisorTrap2();
    static void handleSupervisorTrap3();
